                    ...
                    <div className="space-y-8 animate-in fade-in duration-500">
                        ...
                        <div className="grid gap-6">
                            <div className={`p-6 rounded-lg border ${theme.border} hover:border-blue-300 hover:shadow-md transition-all ${theme.cardBg}`}>
                                <h4 className={`text-lg font-semibold mb-2 ${theme.text}`}>AI Tools Network</h4>
                                <p className={`${theme.textSecondary} mb-4 text-sm`}>
                                    Interactive network visualization of AI tools and their relationships.
                                </p>
                                <div className="flex gap-4">
                                    <a href="https://zabbonat.github.io/AI-Tools_Network/" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center gap-2 text-sm ${theme.accent} hover:underline`}>
                                        Launch Visualization <ExternalLink size={14} />
                                    </a>
                                    <a href="https://github.com/zabbonat/AI-Tools_Network" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center gap-2 text-sm ${theme.textSecondary} hover:${theme.text}`}>
                            ...
                            <div className={`p-6 rounded-lg border ${theme.border} hover:border-blue-300 hover:shadow-md transition-all ${theme.cardBg}`}>
                                <h4 className={`text-lg font-semibold mb-2 ${theme.text}`}>DDI Model</h4>
                                <p className={`${theme.textSecondary} mb-4 text-sm`}>
                                    A fine-tuned transformer model designed to detect Data-Driven Innovation (DDI) concepts in text.
                                </p>
                                <a href="https://huggingface.co/Zabbonat/DDI" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center gap-2 text-sm ${theme.accent} hover:underline`}>
                ...
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h4 className={`text-lg font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'} mb-4`}>Published Papers</h4>
                                <ul className={`space-y-4 list-disc pl-5 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                                    <li>
                                        ...
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Abbonato, D., Bianchini, S., Gargiulo, F., & Venturini, T. (2024) - Quantitative Science Studies</span>
                                        <br />
                                        <a href="https://doi.org/10.1162/qss_a_00288" target="_blank" rel="noopener noreferrer" className={`text-sm ${theme.accent} hover:underline`}>Read Paper</a>
                                    </li>
                                </ul>
                            </div>

                            <div>
                                <h4 className={`text-lg font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'} mb-4`}>Preprints</h4>
                                <ul className={`space-y-4 list-disc pl-5 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                                    <li>
                                        <strong>Mapping AI’s Labor Impact: A Task Exposure Framework for Occupational Analysis</strong>
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Jurowetzki, R., Squicciarini, M., Abbonato, D. (2025)</span>
                                        <br />
                                        <a href="https://vbn.aau.dk/ws/portalfiles/portal/793096244/361nu7zlk9zt692qz3e8x1rx9hj8au-5.pdf" target="_blank" rel="noopener noreferrer" className={`text-sm ${theme.accent} hover:underline`}>PDF</a>
                                    </li>
                                    <li>
                                        <strong>Public sentiments on the fourth industrial revolution: An unsolicited public opinion poll from Twitter</strong>
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Abbonato, D. (2024)</span>
                                        <br />
                                        <a href="https://arxiv.org/abs/2411.14230" target="_blank" rel="noopener noreferrer" className={`text-sm ${theme.accent} hover:underline`}>arXiv</a>
                                    </li>
                                </ul>
                            </div>

                            <div>
                                <h4 className={`text-lg font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'} mb-4`}>Work in Progress</h4>
                                <ul className={`space-y-4 list-disc pl-5 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                                    <li>
                                        <strong>Partnerships is all you need: The development of transformer technology and its impact on science</strong>
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Abbonato, D., Bianchini, S., Llerena, P. (2024)</span>
                                    </li>
                                    <li>
                                        ...
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Abbonato, D., Guerzoni, M.</span>
                                    </li>
                                    <li>
                                        ...
                                        <br />
                                        <span className={`text-sm ${theme.textMuted}`}>Abbonato, D., Di Pietro, F., Guerzoni, M.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="mt-12 text-center">
                            <a href="https://scholar.google.com/citations?user=no8pRaUAAAAJ&hl=en&oi=ao" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center gap-2 px-6 py-2 ${theme.buttonBg} rounded ${theme.buttonHover} text-white transition-colors`}>
                    ...
                    <div className="space-y-8 animate-in fade-in duration-500">
                        ...
                        <div className="space-y-6">
                            <div className={`${theme.cardBgAlt} p-6 rounded-lg border ${theme.border}`}>
                                <h4 className={`font-semibold ${theme.text} mb-4`}>Teaching History</h4>
                                <div className="space-y-4">
                                    {courses.map((course, index) => (
                                        <div key={index} className={`${theme.cardBg} p-4 rounded border ${theme.border} hover:border-blue-300 transition-colors`}>
                                            <div className="flex justify-between items-start mb-2">
                                                <h4 className={`font-bold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'} text-sm`}>{course.title}</h4>
                                                <span className={`text-xs font-medium ${theme.accent} ${isDarkMode ? 'bg-blue-900/30' : 'bg-blue-50'} px-2 py-1 rounded whitespace-nowrap ml-2`}>
                                                    {course.date}
                                                </span>
                                            </div>
                                            <p className={`text-xs ${theme.textSecondary} mb-2`}>{course.context}</p>
                                            <div className={`flex flex-wrap gap-3 text-[10px] ${theme.textMuted}`}>
                            ...
                            <div className={`flex items-center justify-between p-6 ${isDarkMode ? 'bg-blue-900/20 border-blue-800' : 'bg-blue-50 border-blue-100'} rounded-lg border`}>
                                <div>
                                    <h4 className={`font-semibold ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>Course Materials</h4>
                                    <p className={`text-sm ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>Access lecture notes and datasets.</p>
                                </div>
                    ...
                    <div className="space-y-8 animate-in fade-in duration-500">
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className={`${theme.cardBg} p-6 rounded-lg border ${theme.border} shadow-sm`}>
                                <h4 className={`font-bold ${theme.text} mb-4 flex items-center gap-2`}>
                                ...
                                <ul className="space-y-4">
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>Ph.D. in Economics</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>University of Strasbourg (2020-2024)</div>
                                    </li>
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>M.Sc. in Data Science</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>Sapienza University of Rome (2018-2020)</div>
                                    </li>
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>B.Sc. in Statistics</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>Sapienza University of Rome (2015-2018)</div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className={`${theme.cardBg} p-6 rounded-lg border ${theme.border} shadow-sm`}>
                                ...
                                <ul className="space-y-4">
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>Postdoctoral Researcher</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>University of Turin (Current)</div>
                                    </li>
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>Postdoctoral Researcher</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>University of Milan-Bicocca (2024-2025)</div>
                                    </li>
                                    <li className={`pl-4 border-l-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                                        <div className={`font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>Visiting Researcher</div>
                                        <div className={`text-sm ${theme.textSecondary}`}>University of Bremen (2023)</div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className={`${theme.cardBg} p-6 rounded-lg border ${theme.border} shadow-sm`}>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['R', 'Python', 'SAS', 'Java', 'C++', 'MATLAB', 'SQL', 'Gephi', 'Docker', 'Git', 'LaTeX', 'Torch', 'Tensorflow'].map((skill) => (
                                        <span key={skill} className={`px-3 py-1 ${isDarkMode ? 'bg-slate-800 text-slate-300 border-slate-700' : 'bg-slate-100 text-slate-700 border-slate-200'} rounded-full text-xs font-medium border`}>
                                            {skill}
                                        </span>
                                    ))}
                                </div>
