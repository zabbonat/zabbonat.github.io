                        ...
                        <AnimatePresence>
                            {showDialog && (
                                <motion.div
                                    ...
                                    className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 -ml-3 w-64 bg-white border-4 border-black p-4 rounded-lg shadow-xl z-50 pointer-events-auto cursor-pointer"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        advanceDialog();
                                    }}
